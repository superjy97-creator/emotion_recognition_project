...
프로젝트 공동작업물에는 RGB 컬러 JPG 기반 학습 결과와 흑백 PNG 기반 학습·평가 결과가 함께 포함되어 있으며, 모델별 성능 비교 자료와 평가 결과를 저장하였습니다.
...
`06_outputs` 폴더에는 RGB 컬러 학습 결과와 모델 간 비교 결과가 저장되어 있습니다.
...
- 학습 완료 모델과 평가 결과는 재현성과 결과 확인을 위해 관리합니다.
